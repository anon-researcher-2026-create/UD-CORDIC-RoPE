...
if {$_slk_ != "1354.6"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1354.6,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "1903"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 1903,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "946"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 946,  current net area: $_net_area_"
}
unset _net_area_
