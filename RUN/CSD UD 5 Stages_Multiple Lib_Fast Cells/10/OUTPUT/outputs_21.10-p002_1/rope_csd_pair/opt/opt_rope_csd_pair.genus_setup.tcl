...
if {$_slk_ != "1181.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1181.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "2942"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 2942,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "1463"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1463,  current net area: $_net_area_"
}
unset _net_area_
