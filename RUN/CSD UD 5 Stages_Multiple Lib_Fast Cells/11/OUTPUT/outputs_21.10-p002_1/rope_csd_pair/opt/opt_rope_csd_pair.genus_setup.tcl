...
if {$_slk_ != "1126.2"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1126.2,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "3218"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 3218,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "1580"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1580,  current net area: $_net_area_"
}
unset _net_area_
