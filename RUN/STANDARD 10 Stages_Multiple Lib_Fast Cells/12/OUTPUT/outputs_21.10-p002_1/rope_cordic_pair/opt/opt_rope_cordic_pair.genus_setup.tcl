...
if {$_slk_ != "1173.9"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1173.9,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "5378"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 5378,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "2271"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 2271,  current net area: $_net_area_"
}
unset _net_area_
