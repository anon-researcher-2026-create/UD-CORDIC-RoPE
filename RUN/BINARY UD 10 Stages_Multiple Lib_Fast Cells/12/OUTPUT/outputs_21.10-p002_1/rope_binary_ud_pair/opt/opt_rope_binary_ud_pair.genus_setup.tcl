...
if {$_slk_ != "1342.3"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1342.3,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_net_area_ != "1399"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1399,  current net area: $_net_area_"
}
unset _net_area_
