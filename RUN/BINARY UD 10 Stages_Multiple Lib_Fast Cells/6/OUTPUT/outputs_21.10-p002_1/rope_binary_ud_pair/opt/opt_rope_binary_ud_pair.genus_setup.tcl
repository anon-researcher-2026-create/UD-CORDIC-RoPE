...
if {$_slk_ != "1611.1"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1611.1,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "2728"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 2728,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "1062"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1062,  current net area: $_net_area_"
}
unset _net_area_
